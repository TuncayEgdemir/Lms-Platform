 ...
 * Use the exports from /server instead
 */
export type WithServerSideAuthCallback<Return, Options extends WithServerSideAuthOptions> = (context: ContextWithAuth<Options>) => Return;
/**
 * @deprecated The /middleware path is deprecated and will be removed in the next major release.
 * Use the exports from /server instead
 */
export type WithServerSideAuthResult<CallbackReturn> = (context: GetServerSidePropsContext) => Promise<Awaited<CallbackReturn>>;
/**
 * @deprecated The /middleware path is deprecated and will be removed in the next major release.
 * Use the exports from /server instead
 */
