...
function getAuthKeyFromRequest(req, key) {
  return getCustomAttributeFromRequest(req, import_backend.constants.Attributes[key]) || getHeader(req, import_backend.constants.Headers[key]) || (key === "AuthStatus" ? getQueryParam(req, import_backend.constants.SearchParams.AuthStatus) : void 0);
}
...
const handleMultiDomainAndProxy = (req, opts) => {
  ...
  const relativeOrAbsoluteProxyUrl = (0, import_handleValueOrFn.handleValueOrFn)(opts?.proxyUrl, requestURL, import_clerkClient.PROXY_URL);
  let proxyUrl;
  ...
  const signInUrl = opts?.signInUrl || import_clerkClient.SIGN_IN_URL;
