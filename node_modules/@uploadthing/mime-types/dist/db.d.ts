declare const mimeTypesInternal: {
    ...
    readonly "image/jpeg": {
        readonly source: "iana";
        readonly compressible: false;
        readonly extensions: readonly ["jpeg", "jpg", "jpe"];
    };
    readonly "image/jph": {
        readonly source: "iana";
    ...
    readonly "message/disposition-notification": {
        readonly source: "iana";
        readonly extensions: readonly ["disposition-notification"];
        readonly compressible: null;
    };
    readonly "message/global": {
        readonly source: "iana";
        readonly extensions: readonly ["u8msg"];
        readonly compressible: null;
    };
    readonly "message/global-delivery-status": {
        readonly source: "iana";
        readonly extensions: readonly ["u8dsn"];
        readonly compressible: null;
    };
    readonly "message/global-disposition-notification": {
        readonly source: "iana";
        readonly extensions: readonly ["u8mdn"];
        readonly compressible: null;
    };
    readonly "message/global-headers": {
        readonly source: "iana";
        readonly extensions: readonly ["u8hdr"];
        readonly compressible: null;
    };
    readonly "message/rfc822": {
        readonly source: "iana";
        readonly compressible: true;
        readonly extensions: readonly ["eml", "mime"];
    };
    readonly "message/vnd.wfa.wsc": {
        readonly source: "iana";
    ...
    readonly "model/gltf+json": {
        readonly source: "iana";
        readonly compressible: true;
        readonly extensions: readonly ["gltf"];
    };
    readonly "model/gltf-binary": {
        readonly source: "iana";
        readonly compressible: true;
    ...
    readonly "model/step+xml": {
        readonly source: "iana";
        readonly compressible: true;
        readonly extensions: readonly ["stpx"];
    };
    readonly "model/step+zip": {
        readonly source: "iana";
        readonly compressible: false;
        readonly extensions: readonly ["stpz"];
    };
    readonly "model/step-xml+zip": {
        readonly source: "iana";
        readonly compressible: false;
    ...
    readonly "x-conference/x-cooltalk": {
        readonly source: "apache";
        readonly extensions: readonly ["ice"];
        readonly compressible: null;
    };
};
type FileExtension = (typeof mimeTypesInternal)[keyof typeof mimeTypesInternal]["extensions"][number];
type MimeType = keyof typeof mimeTypesInternal;
type TypedMimeTypes = Record<MimeType, {
    source: string;
    extensions: FileExtension[];
    compressible: boolean | null;
}>;
declare const mimeTypes: TypedMimeTypes;
type MimeValue = (typeof mimeTypes)[MimeType];

export { FileExtension, MimeType, MimeValue, mimeTypes };
