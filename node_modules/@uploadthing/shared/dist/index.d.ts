...
type RequestLike = Overwrite<WithRequired<Partial<Request>, "json">, {
    body?: any;
...
declare function safeParseJSON<T>(input: string | ResponseEsque | RequestLike): Promise<T | Error>;
...
export { ALLOWED_FILE_TYPES, AllowedFileType, ContentDisposition, ExpandedRouteConfig, FILESIZE_UNITS, FetchEsque, FileData, FileRouterInputConfig, FileRouterInputKey, FileSize, FileSizeUnit, Json, JsonArray, JsonObject, JsonValue, MaybeUrl, Overwrite, RequestInitEsque, RequestLike, ResponseEsque, SizeUnit, UploadThingError, UploadedFile, WithRequired, fileSizeToBytes, fillInputRouteConfig, generateUploadThingURL, getDefaultSizeForType, getStatusCodeFromError, getTypeFromFileName, isObject, isRouteArray, objectKeys, pollForFileData, safeParseJSON, withExponentialBackoff };
